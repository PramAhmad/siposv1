<template>
    <div>
        <MyNavbar/>
        <div class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover pt-20"
    >
    ...
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div id="profile"
            ...
            v-for="data in mahasiswa" :key="data.id">
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
                    :style="{ backgroundImage: `url(${data.foto})` }"></div>
                <h1 class="text-3xl font-bold pt-8 lg:pt-0">{{ data.nama }}</h1>
                <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-sky-500 opacity-25"></div>
                <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                    <svg class="h-4 fill-current text-sky-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    <a class="link" href="#" data-tippy-content="@facebook_handle">
                        <svg class="h-6 fill-current text-gray-600 hover:text-sky-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" href="#" data-tippy-content="@youtube_handle">
                        <svg class="h-6 fill-current text-gray-600 hover:text-sky-700" role="img"
        ...
        <!--Img Col-->
        <div class="w-full lg:w-2/5" v-for="data in mahasiswa" :key="data.ids">
            <!-- Big profile image for side bar (desktop) -->
            <img :src="data.foto" class="rounded-none lg:rounded-lg w-full h-full shadow-2xl hidden lg:block">
