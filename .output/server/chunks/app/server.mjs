import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, computed, unref, h, Suspense, nextTick, Transition, toRef, isRef, mergeProps, provide, shallowReactive, useSSRContext, createApp, reactive, effectScope, isReactive, toRaw, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, toRefs, markRaw, defineAsyncComponent, isShallow, withCtx } from 'vue';
import { f as useRuntimeConfig$1, l as withQuery, m as hasProtocol, p as parseURL, j as joinURL, i as createError$1, n as defu, $ as $fetch, o as sanitizeStatusCode, q as createHooks, r as parse, t as destr, v as isEqual, x as setCookie, y as getCookie, z as deleteCookie } from '../nitro/node-server.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.path) ?? "/admin/payment/:room()/:id()",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/admin/payment/:room()",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/admin/payment/:room()/setting",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/admin/payment/:room()/tambah",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/admin/payment",
  ...
  },
  {
    ...
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/admin/payment/tambah",
...
const azureBlobStorage_RQAZkTAzB2 = () => {
};
const plugins = [
  plugin$1,
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-8a292ba6.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
