...
const callRender = (e, t, o, n) => {
 ...
 e.insertAdjacentElement = function(e, o) {
  if ("afterbegin" !== e && "beforeend" !== e) return t.call(this, e, o);
  "afterbegin" === e ? this.prepend(o) : "beforeend" === e && this.append(o);
 };
 ...
 if (e.map((e => {
  e[1].map((o => {
   ...
   BUILD.patchPseudoShadowDom && BUILD.scoped ? patchPseudoShadowDom(i.prototype, n) : (BUILD.slotChildNodesFix && patchChildSlotNodes(i.prototype, n), 
   BUILD.cloneNodeFix && patchCloneNode(i.prototype), BUILD.appendChildSlotFix && patchSlotAppendChild(i.prototype), 
   BUILD.scopedSlotTextContentFix && patchTextContent(i.prototype, n)), BUILD.hotModuleReplacement && (i.prototype["s-hmr"] = function(e) {
    ((e, t, o) => {
   ...
   }), n.$lazyBundleId$ = e[0], l.includes(r) || a.get(r) || (s.push(r), a.define(r, proxyComponent(i, n, 1)));
  }));
