...
const callRender = (e, t, a, o) => {
 ...
 e.insertAdjacentElement = function(e, a) {
  if ("afterbegin" !== e && "beforeend" !== e) return t.call(this, e, a);
  "afterbegin" === e ? this.prepend(a) : "beforeend" === e && this.append(a);
 };
...
exports.addHostEventListeners = addHostEventListeners, exports.bootstrapLazy = (e, t = {}) => {
 ...
 if (e.map((e => {
  e[1].map((a => {
   ...
   appData.BUILD.patchPseudoShadowDom && appData.BUILD.scoped ? patchPseudoShadowDom(p.prototype, o) : (appData.BUILD.slotChildNodesFix && patchChildSlotNodes(p.prototype, o), 
   appData.BUILD.cloneNodeFix && patchCloneNode(p.prototype), appData.BUILD.appendChildSlotFix && patchSlotAppendChild(p.prototype), 
   appData.BUILD.scopedSlotTextContentFix && patchTextContent(p.prototype, o)), appData.BUILD.hotModuleReplacement && (p.prototype["s-hmr"] = function(e) {
    ((e, t, a) => {
