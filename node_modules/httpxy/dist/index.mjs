...
function defineProxyMiddlware(m) {
  return m;
}
function defineProxyOutgoingMiddlware(m) {
  return m;
}
...
const XHeaders$1 = defineProxyMiddlware((req, res, options) => {
  if (!options.xfwd) {
    return;
  }
...
const stream$1 = defineProxyMiddlware(
