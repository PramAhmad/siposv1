...
class Integration extends __1.BaseIntegration {
    ...
    async add(details) {
        ...
        if (details.enableArgs) {
            const parsedArgs = (0, cli_framework_1.parseArgs)(details.enableArgs, { string: ['app-id', 'key'] });
    ...
    async chooseApp(apps, org) {
        ...
        const newAppChoice = {
            name: (0, color_1.strong)('Create A New App'),
    ...
    async updateNPMRC() {
        ...
        let npmrc = '';
        try {
            npmrc = await (0, utils_fs_1.readFile)(path.join(this.e.project.directory, '.npmrc'), 'utf8');
        }
        catch (e) {
        ...
        await (0, utils_fs_1.writeFile)(path.join(this.e.project.directory, `.npmrc`), npmrc, { encoding: 'utf8' });
    }
    get config() {
