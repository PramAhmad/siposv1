...
class AngularServeRunner extends serve_1.ServeRunner {
    ...
    async getCommandMetadata() {
        return {
            description: `
${(0, color_1.input)('ionic serve')} uses the Angular CLI. Use ${(0, color_1.input)('ng serve --help')} to list all Angular CLI options for serving your app. See the ${(0, color_1.input)('ng serve')} docs[^ng-serve-docs] for explanations. Options not listed below are considered advanced and can be passed to the Angular CLI using the ${(0, color_1.input)('--')} separator after the Ionic CLI arguments. See the examples.

The dev server can use HTTPS via the ${(0, color_1.input)('--ssl')} option ${chalk.bold.red('(experimental)')}. There are several known issues with HTTPS. See issue #3305[^issue-3305].
`,
            footnotes: [
                {
                    id: 'ng-serve-docs',
            ...
            options: [
                ...
                },
                {
                    ...
                    type: Boolean,
                    groups: ["experimental" /* MetadataGroup.EXPERIMENTAL */, 'cordova'],
                    hint: (0, color_1.weak)('[ng]'),
                },
                {
                    name: 'prod',
    ...
    createOptionsFromCommandLine(inputs, options) {
        ...
        const consolelogsPort = consolelogs ? (0, string_1.str2num)(options['consolelogs-port'], serve_1.DEFAULT_DEV_LOGGER_PORT) : undefined;
        return {
            ...baseOptions,
            consolelogs,
            consolelogsPort,
